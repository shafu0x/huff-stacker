...
macro_rules! define_opcode {
    ($name:ident, $name_str:expr, $pops:expr, $pushes:expr, $sign:expr) => {
...
define_opcode!(CALL, "call", 7, 1, None);
...
define_opcode!(CREATE2, "create2", 4, 1, None);
define_opcode!(STATICCALL, "staticcall", 6, 1, None);
